...
from app.models.trade import Trade, TradingSignal, Position
...
async def get_trades(
    ...
    try:
        ...
        trades = query.order_by(Trade.trade_time.desc()).offset(skip).limit(limit).all()
...
async def get_trading_signals(
    ...
    try:
        ...
        signals = query.order_by(TradingSignal.signal_time.desc()).offset(skip).limit(limit).all()
